...
trait Async2[F[_]] extends Sync[F] with Temporal[F] {

  def async[A](
      k: (Either[Throwable, A] => Unit) => F[Option[F[Unit]]]
  ): F[A] = {
  ...
  def backgroundOn[A](
      fa: F[A],
      ec: ExecutionContext
  ): Resource[F, F[Outcome[F, Throwable, A]]] =
...
object Async2 {
  ...
  def defaultCont[F[_], K, R](
      body: Cont[F, K, R]
  )(implicit F: Async2[F]): F[R] = {
    sealed trait State
          ...
          state.get match {
            ...
            case Initial() =>
              F.async { cb =>
                ...
                def onCancel =
                  F.delay(state.compareAndSet(waiting, Initial())).void
  ...
  implicit def asyncForOptionT[F[_]](implicit
      F0: Async2[F]
  ): Async2[OptionT[F, *]] =
    new OptionTAsync[F] {
      override implicit protected def F: Async2[F] = F0
    }

  implicit def asyncForEitherT[F[_], E](implicit
      F0: Async2[F]
  ): Async2[EitherT[F, E, *]] =
  ...
  implicit def asyncForIorT[F[_], L](implicit
      F0: Async2[F],
      L0: Semigroup[L]
  ): Async2[IorT[F, L, *]] =
    new IorTAsync[F, L] {
  ...
  implicit def asyncForWriterT[F[_], L](implicit
      F0: Async2[F],
      L0: Monoid[L]
  ): Async2[WriterT[F, L, *]] =
  ...
  implicit def asyncForKleisli[F[_], R](implicit
      F0: Async2[F]
  ): Async2[Kleisli[F, R, *]] =
  ...
  private[effect] trait OptionTAsync[F[_]]
      ...
      OptionT(
        F.cont(
          new Cont[F, K, Option[R]] {
            ...
            override def apply[G[_]](implicit
    ...
    def executionContext: OptionT[F, ExecutionContext] =
  ...
  private[effect] trait EitherTAsync[F[_], E]
    ...
    def executionContext: EitherT[F, E, ExecutionContext] =
  ...
  private[effect] trait IorTAsync[F[_], L]
    ...
    def executionContext: IorT[F, L, ExecutionContext] =
  ...
  private[effect] trait WriterTAsync[F[_], L]
    ...
    def executionContext: WriterT[F, L, ExecutionContext] =
  ...
  private[effect] trait KleisliAsync[F[_], R]
    ...
    def executionContext: Kleisli[F, R, ExecutionContext] =
